...
test_case = "1-LV-rural1--2-no_sw.xlsx"
...
potpourri.acopf(tc=test_case, solver="ipopt", print_output=False, print_solver_output=True, print_model=False, objective="multiperiod_battery_simplified")
#potpourri.acopf(tc=test_case, solver="ipopt", print_output=False, print_solver_output=True, print_model=False, objective="multiperiod_battery_relaxed")
