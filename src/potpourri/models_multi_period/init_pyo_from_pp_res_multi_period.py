"""Warm-start utilities: initialise multi-period Pyomo variables from a pandapower DC power flow result."""
...
def init_pyo_from_dcpp(net, model):
    ...
    Args:
        ...
        model: Pyomo ConcreteModel with variables delta, pLfrom, pLto, pThv, pTlv, pG, and optionally v.
    """
    pp.rundcpp(net)
