...
net_opf.sgen["min_p_mw"] = (
    net_opf.sgen["p_mw"] * 0.0
)  # can curtail down to zero

# External grid: allow both import and export
net_opf.ext_grid["max_p_mw"] = 10000.0
net_opf.ext_grid["min_p_mw"] = -10000.0
...
dcopf.model.obj = pe.Objective(
    expr=sum(dcopf.model.pG[g] for g in dcopf.model.G), sense=pe.minimize
)
