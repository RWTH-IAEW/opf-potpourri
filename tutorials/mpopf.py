...
#
# Now, we instantiate the multiperiod ACOPF model from potpourri and add the optimization problem.
# The objective function can be set separately. In this case, we are minimizing the voltage deviation.
# %%
